  ...
  <div class="container py-5 h-100">
    <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="card">
          ...
          //* Si client et idClient == $_GET['id'] => liste des photos achetées 
          if ($check_grade == 'client' && $_SESSION['id'] == $_GET['id']) {

            //* Liste des images achetées par l'utilisateur
            ...
            if ($req_img->rowCount() > 0) {
              ...
              if ($req_img->rowCount() == 1) {
                echo '    <p class="lead fw-normal mb-0">Photos achetée</p>';
              } else {
                echo '    <p class="lead fw-normal mb-0">Photos achetées</p>';
              }
              echo '  </div>';
              echo '  <div class="row g-2">';
              $data_img = $req_img->fetchAll();
