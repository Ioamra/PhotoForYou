...
function actuPanier() {
    if (getNombreProduit() == 0) {
        ...
        for (let i = 0; i < panier.length; i++) {
            ...
            contenu += '        <svg onclick="tooglePanier()" role="button" style="position:absolute; right:10px;" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">';
            ...
            contenu += '        </svg>';
            contenu += '        <br><div class="">'+panier[i]['nom']+'</div>';
